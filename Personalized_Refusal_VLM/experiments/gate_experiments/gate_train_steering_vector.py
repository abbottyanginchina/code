...
def train(cfg, start_layer, end_layer, output_dir):
    ...
    for layer in range(start_layer, end_layer): 
        ...
        for epoch in range(cfg.training.epochs):
            ...
            for x, target, y, gt_vec_batch in data_loader:
                ...
                loss = loss_pos + 0 * loss_neg + 1.0 * loss_ortho + 1.0 * loss_gate
...
if __name__ == '__main__':
    ...
    output_dir = os.path.join(cfg.output_dir, f"gate_{cfg.model_name}_{cfg.data.dataset_name}_{cfg.data.subject}")
