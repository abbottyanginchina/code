...
def eval_model(cfg, output_dir):
    ...
    # 生成拒绝测试集
    answers_file = f"{output_dir}/results/sysprompt_non{cfg.data.subject}_answer_{cfg.model_name}.jsonl"
...
if __name__ == "__main__":
    ...
    output_dir = f"{cfg.output_dir}/output_sys_prompt_{cfg.model_name}_{cfg.data.dataset_name}_{cfg.data.subject}"
