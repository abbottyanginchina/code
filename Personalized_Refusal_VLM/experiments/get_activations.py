...
def eval_model(cfg):
    ...
    with torch.no_grad():
        with_sys_in_train_activations = process(get_activations(model, without_sys_in_train_text, in_train_images, processor, system_prompt=True))
    ...
    save_path = f"../results/Persona_output_{cfg.model_name}_{cfg.data.dataset_name}_{cfg.data.subject}/activations/"
