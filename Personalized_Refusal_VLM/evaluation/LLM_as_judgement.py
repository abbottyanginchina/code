...
if __name__ == '__main__':
    # read .jsonl file
    data_path = '/Users/abbottyang/Library/Mobile Documents/com~apple~CloudDocs/PhD_Study/code/autodl/output/baseline_results/baseline_results/llava-1.5-7b-hf_ScienceQA_biology/out_of_constraint_answer.jsonl'
