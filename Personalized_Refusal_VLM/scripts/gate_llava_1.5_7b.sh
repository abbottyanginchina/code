...
process_subject() {
    ...
    python -m experiments.gate_experiments.orth_get_activations_inst --model_name $model_name --num_test $num_test --num_train $num_train --dataset $dataset --subject $subject
