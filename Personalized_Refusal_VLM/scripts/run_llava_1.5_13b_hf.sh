...
process_subject() {
    ...
    python -m experiments.inference_activations --start_layer 0 --end_layer $num_layers --subject $subject --model_name $model_name --dataset $dataset ---num_test $num_test --num_train $num_train
