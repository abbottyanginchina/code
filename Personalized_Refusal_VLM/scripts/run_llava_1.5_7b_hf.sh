...
python -m experiments.train_steering_vector --model_name $model_name --start_layer 25 --end_layer 26 
...
python -m experiments.inference_activations --start_layer 20 --end_layer 33
