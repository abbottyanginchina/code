...
process_subject() {
    ...
    python -m experiments.vision_experiments.orth_inference_activations --start_layer 0 --end_layer $num_layers --subject $subject --dataset $dataset --model_name $model_name
